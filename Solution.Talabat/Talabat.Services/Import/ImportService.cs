...
namespace Talabat.Services.Import
{
    public class ImportService : IimportService
    {
        ...
        public async Task<ImportToReturnDTO<DTO>> ExcelImportAsync<DTO>(ImportDTO<DTO> dTO)
        {
            var config = dTO.Config ?? new ImportExcelConfig<DTO>();
        ...
        // Helper Methods
        private static Dictionary<PropertyInfo, int> BuildPropertyMap<DTO>(IXLWorksheet worksheet, ImportExcelConfig<DTO> config, List<string> errors)
        {
        ...
        private static Dictionary<string, int> GetHeaderMap<DTO>(IXLWorksheet worksheet, ImportExcelConfig<DTO> config)
        {
